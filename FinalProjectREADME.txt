...
3 - PCV.ntail.xd_sparse_path_19frames.ipynb shows the calculation of tica,rmsd(using plumed driver) and Sa/Q based S,Z  path collective variables for the sparse guess frame set and shortened path.
 Also calculates the S,Z for for a tp trajectory at 300K.

4 -PCV.ntail.xd_enhanced_path_Nframes_32.ipynb Calculates the same quatities as 3 but with an denser guess path. Also calculates the S,Z for for a tp trajectory at 300K.
